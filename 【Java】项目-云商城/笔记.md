...
## 4、创建 mall-service-goods 商品微服务 8081
...
| 查 - 分页查询 | ![image-20220112210041989](image/image-20220112210041989.png) | http://localhost:8081/brand/search/1/2 |
...
## 2、搭建 mall-service-cephfile 文件上传微服务 8082
