...
# Linux - 挂载配置文件
docker run -di --name=es -p 9200:9200 -p 9300:9300  -v /docker_data/es/conf/elasticsearch.yml:/usr/share/elasticsearch/config/elasticsearch.yml -v /docker_data/es/plugins:/usr/share/elasticsearch/plugins elasticsearch:6.8.12
...
# 进入容器
docker exec -it eshead /bin/bash
...
- 访问地址：http://192.168.126.200:9100
