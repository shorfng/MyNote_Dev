...
```bash
# 运行
docker run -itd --name nginx -d -p 80:80 -v /Users/td/Documents/03_DevTools/docker_data/nginx/conf/nginx.conf:/etc/nginx/nginx.conf -v /Users/td/Documents/03_DevTools/docker_data/nginx/logs:/var/log/nginx --net=host nginx:1.20.0-alpine
...
docker run -d -p 80:80 --name nginx -v /Users/td/Documents/03_DevTools/docker_data/nginx/conf/nginx.conf:/etc/nginx/nginx.conf -v /Users/td/Documents/03_DevTools/docker_data/nginx/logs:/var/log/nginx -v /Users/td/Documents/03_DevTools/docker_data/nginx/html:/usr/share/nginx/html nginx:1.20.0-alpine
```
...
![image-20210906150341238](image/image-20210906150341238.png)
