...
# Mac 系统
docker run -d -p 6379:6379 -v /Users/td/Documents/03_DevTools/docker_data/redis/redis.conf:/usr/local/etc/redis/redis.conf -v /Users/td/Documents/03_DevTools/docker_data/redis/data:/data --name redis redis:5.0.13 redis-server  /usr/local/etc/redis/redis.conf --appendonly yes  --requirepass "root"
```
